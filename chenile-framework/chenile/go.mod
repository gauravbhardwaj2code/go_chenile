module github.com/gauravbhardwaj2code/go_chenile/chenile-framework/chenile

go 1.26

toolchain go1.26.3

require github.com/gauravbhardwaj2code/go_chenile/chenile-framework/core v0.1.1
